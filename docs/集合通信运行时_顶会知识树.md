...
| 工作 | 会议 | 改什么 | 何时改 | 不改什么 |
| --- | --- | --- | --- | --- |
| Theseus | SIGCOMM'26 | 整张 schedule | 预定义候选之间热插拔；资源树 + delta 迁移 + 一致性协议 | 不在线重综合；候选必须事先算好 |
...
Theseus 数字（论文）：稳态约 1.61x（与 MSCCL++ 空间混用）、动态约 2.46x、慢节点 JCT 约 1.84x、MoE EP32 约 1.07x。
